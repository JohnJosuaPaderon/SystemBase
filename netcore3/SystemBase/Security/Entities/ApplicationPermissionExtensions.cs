...
namespace SystemBase.Security.Entities
{
    ...
    {
        public static async Task<Application> GetApplicationAsync(this ApplicationPermission instance, IApplicationRepository repository, CancellationToken cancellationToken = default)
        {
            if (instance is null)
                return null;
