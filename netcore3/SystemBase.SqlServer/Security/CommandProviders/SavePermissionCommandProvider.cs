...
namespace SystemBase.Security.CommandProviders
{
    ...
    {
        private const string PROCEDURE = "[Security].[SavePermission]";
        private const string PARAM_ID = "@Id";
        private const string PARAM_NAME = "@Name";
        private const string PARAM_CODE = "@Code";
        private const string PARAM_SCOPEID = "@ScopeId";
        ...
        public SavePermissionCommandProvider(ICurrentSessionProvider sessionProvider)
        {
            _sessionProvider = sessionProvider;
        }

        private SqlCommand Get(Permission permission, SqlConnection connection, SqlTransaction transaction = default) =>
            ...
            .AddInParameter(PARAM_SCOPEID, permission.ScopeId)
            .AddSessionIdParameter(_sessionProvider);

        public async Task<Permission> ExecuteAsync(Permission permission, SqlConnection connection, SqlTransaction transaction = default, CancellationToken cancellationToken = default)
        {
